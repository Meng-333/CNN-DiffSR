...
from archs.DDPM_unet_arch import *
...
class DDPMSRModel(pl.LightningModule):
    ...
    def training_step(self, batch):
        ...
        if self.current_epoch < self.pretrain_epochs:
            ...
            #sr = self.diffusion.super_resolution({"HR": hr, "SR": hr_})
    ...
    def validation_step(self, batch, *args, **kwargs):
        ...
        #sr = self.diffusion.super_resolution(lr_upsampled)
        if len(sr.shape) == 3:
            sr.unsqueeze_(0)
    ...
    def validation_epoch_end(self, outputs):
        ...
        #f = open('./logs/ddpm_diffsr/validation_epoch_end.txt', 'a')
        #f = open('./logs/ddpm_fastdiffsr/validation_epoch_end.txt', 'a')
        #f = open('./logs/ddim_fastdiffsr/validation_epoch_end.txt', 'a')
        f = open('./logs/ddpm_CNN-fastdiffsr/validation_epoch_end.txt', 'a')
