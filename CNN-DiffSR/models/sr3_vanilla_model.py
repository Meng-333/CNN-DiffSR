...
class SR3VanillaModel(pl.LightningModule):
    ...
    def training_step(self, batch, *args):
        ...
        hr_ = self.encoder(lr)  # srdsran loss
    ...
    def validation_step(self, batch, *args, **kwargs):
        ...
        sr = self.netG.super_resolution(conditional_img)
        ...
        result_imgs = [hr_np, hr_np, hr_np, sr_np]
        mses = [None, None, 0.0, mse]
        psnrs = [None, None, 0.0, psnr]
        ssims = [None, None, 0.0, ssim]
        ergass = [None, None, 0.0, ergas]
        lpipss = [None, None, 0.0, lpips]
    ...
    def validation_epoch_end(self, outputs):
        ...
        #f = open('./logs/sr3_diffsr/validation_epoch_end.txt', 'a')
        #f = open('./logs/sr3_fastdiffsr/validation_epoch_end.txt', 'a')
        f = open('./logs/sr3_CNN-fastdiffsr/validation_epoch_end.txt', 'a')
