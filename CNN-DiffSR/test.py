...
def make_dataloaders(datasets, type, scale, config):
    ...
    for dataset_name in datasets:
        if type == "LRHR_paired":
            ...
            dataset = SingleImageDataset(
                #img_path="load/diffsr_data/Test/AID_Test".format(dataset_name),
                #img_path="load/diffsr_data/Test/UCM_Test".format(dataset_name),
                #img_path="load/diffsr_data/Test/NWPU_21Class_HR".format(dataset_name),
                #img_path="load/diffsr_data/Test/NWPU_Test/tennis_court".format(dataset_name),
                #img_path="load/fastdiffsr_data/Test/Potsdam".format(dataset_name),
                img_path="load/fastdiffsr_data/Test/Toronto".format(dataset_name),
                rgb_range=config.data_module.args.rgb_range,
                cache="bin",
                mean=config.data_module.args.get("mean"),
                std=config.data_module.args.get("std"),
...
def getTestParser():
    ...
    parser.add_argument(
        "--datasets", default="load/Test/AID_Test", type=str, help="dataset names"
        #"--datasets",default="load/Test/UCM_Test", type=str, help="dataset names"
        #"--datasets", default="load/Test/NWPU_Test/tennis_court", type=str, help="dataset names"
        #"--datasets",default="load/Test/NWPU_21Class_HR", type=str, help="dataset names"
    )
    parser.add_argument(
        "--datatype",
        default="HR_only",
